...
class GetMsg:
    ...
    async def start_server(self):
        server = await websockets.serve(self.handler, '10.22.0.147', 8765)
        ctx.log.info("WebSocket server started at ws://localhost:8765")
...
# 1、运行命令
# mitmweb -s app.py #打开mitmproxy的web界面
